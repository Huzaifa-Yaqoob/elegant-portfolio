...
ai_buttons:
  - name: "ChatGPT"
    ...
    icon: "open-ai"
  - name: "Claude"
    url: "https://claude.ai/new?q=Tell+me+about+Huzaifa+full-stack+web+developer+and+technical+architect"
    icon: "claude"
  - name: "Gemini"
    url: "https://gemini.google.com/?q=Tell+me+about+Huzaifa+full-stack+web+developer"
    icon: "gemini"
  - name: "Perplexity"
    url: "https://perplexity.ai/?q=Who+is+Huzaifa+the+full-stack+web+developer+from+Lahore+Pakistan"
    icon: "preplexity"
---
